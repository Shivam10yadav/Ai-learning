...
const LoginPage = () => {
   const [state, setState] = React.useState("login")
    ...
    return(
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-black-500 to-red-900 p-4 relative overflow-hidden">
            <form
                onSubmit={handleSubmit}
                className="w-full max-w-md text-center bg-white/6 border border-white/10 rounded-2xl px-8 relative z-10">
            ...
            <div className='fixed inset-0 -z-10 pointer-events-none'>
                <div className='absolute left-1/2 top-20 -translate-x-1/2 w-96 h-96 bg-gradient-to-tr from-indigo-800/35 to-transparent rounded-full blur-3xl' />
                <div className='absolute right-12 bottom-10 w-80 h-80 bg-gradient-to-bl from-indigo-700/35 to-transparent rounded-full blur-2xl' />
            </div>
        </div>
    )
}
